...
java -Duser.language=en XSDValidator ..\..\%1.xml "..\..\infrastructure\cda\CDA_extended.xsd" 1> ..\rapports\%1_validCDA.xml
@echo off
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
:: Test de conformité des sections et entrées aux modèles de contenus CDA
del colle.sch concret.sch
echo.
echo 1) Pre-compilation du schematron : collage des include
@echo on
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Partie à ne garder qu'en développement
:: Test de conformité aux modèles ANS
del colle.sch concret.sch
echo.
echo 1) Pre-compilation du schematron : collage des include
@echo on
...
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\profils\CI-SIS_Modeles_ANS.xsl -o:..\rapports\%1_verif_Modeles_ANS.xml 
@echo off
echo.
...
echo Verification du fichier %1.xml
@echo on
java -cp saxon9he.jar net.sf.saxon.Transform -s:..\..\%1.xml -xsl:..\\profils\terminologies\schematron\terminologie.xsl -o:..\rapports\%1_verif_terminologies.xml 
@echo off
echo.
