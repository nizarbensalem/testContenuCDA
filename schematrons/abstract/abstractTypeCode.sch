...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="abstractTypeCode" abstract="true" 
    ...
    <rule context="$xpath_elt">
        ...
        <assert test="(
            ...
            or  (document($path_jdv3)//svs:Concept[@code=$att_code and @codeSystem=$att_codeSystem]))">
            ...
            doit faire partie du jeu de valeurs <value-of select="$path_jdv1"/> ou <value-of select="$path_jdv2"/> ou <value-of select="$path_jdv3"/> .
        </assert>
    </rule>
</pattern>   
