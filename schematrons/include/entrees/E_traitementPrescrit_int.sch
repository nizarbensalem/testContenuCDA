...
-->
    ...
    <pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_traitementPrescrit_int">
        ...
        <rule context="//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']">
            ...
            <let name="count_id" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:id) "/>  
            <let name="count_code" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:code[@code='DRUG'][@codeSystem='2.16.840.1.113883.5.4'])"/>
            <let name="count_code_1" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:code)"/>
            <let name="count_statusCode" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:statusCode[@code='completed'])"/>
            <let name="count_statusCode_1" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:statusCode)"/>
            <let name="count_text" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:text)"/>
            <let name="count_routeCode" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:routeCode[@codeSystem='2.16.840.1.113883.5.112'])"/> 
            <let name="count_routeCode_1" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:routeCode)"/>
            <let name="count_approachSiteCode_1" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:approachSiteCode)"/> 
            <let name="count_approachSiteCode" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:approachSiteCode[@codeSystem='2.16.840.1.113883.1.11.19724'])"/>
            <let name="count_doseQuantity" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:doseQuantity)"/>  
            <let name="count_rateQuantity" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:rateQuantity)"/>  
            <let name="count_rateQuantity_low" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:rateQuantity/cda:low)"/>  
            <let name="count_rateQuantity_high" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:rateQuantity/cda:high)"/>  
            <let name="count_maxDoseQuantity" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:maxDoseQuantity)"/>  
            <let name="count_maxDoseQuantity_numerator" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:maxDoseQuantity/cda:numerator)"/>  
            <let name="count_maxDoseQuantity_denominator" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:maxDoseQuantity/cda:denominator)"/>  
            <let name="count_author" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:author)"/>  
            <let name="count_reference" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:reference)"/>
            
            <let name="count_effectiveTime" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:effectiveTime)"/>
    
            <let name="count_MA_normales" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.1']])"/>
            <let name="count_MA_progressives" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.8']])"/>   
            <let name="count_MA_fractionnees" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.9']])"/>         
            <let name="count_MA_conditionnees" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.10']])"/> 
            <let name="count_MA_combinees" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.11']])"/> 
            <let name="count_MA_debutDiff" value="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.21']])"/> 
           
            <let name="count_consumable" value="count(//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:consumable/cda:manufacturedProduct[@classCode='MANU']/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.2'])"/> 
            ...
            <let name="count_E_traitementPrescrit" value="count(//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2'])"/>
            ...
            <assert test="($count_text=$count_E_traitementPrescrit)">
            ...
            <assert test="($count_routeCode=1 and $count_routeCode_1=1) or ($count_routeCode_1=0)">
            ...
            <assert test="($count_approachSiteCode&gt;=1 and $count_approachSiteCode_1&gt;=1) or ($count_approachSiteCode_1=0)">
            ...
            <assert test="($count_consumable = $count_E_traitementPrescrit)">
