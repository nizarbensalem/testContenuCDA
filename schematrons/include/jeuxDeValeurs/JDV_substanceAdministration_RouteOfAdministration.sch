...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_substanceAdministration_RouteOfAdministration" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="cda:substanceAdministration[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.7' or cda:templateId/@root='1.2.250.1.213.1.1.3.13' or cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.1.13.3.2']/cda:routeCode"/>
