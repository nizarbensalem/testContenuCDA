...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Vérification de conformité du document aux spécifications du modèle CSE-CS24_2021.01"
                              schemaVersion="CI-SIS_CSE-CS24_2021.01.sch">
         <xsl:attribute name="phase">CI-SIS_CSE-CS24_2021.01</xsl:attribute>
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">S_codedPhysicalExam_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M6"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_abdomen_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M7"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_codedSocialHistory_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M8"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_ears_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M9"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_eatingSleeping_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M10"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_endocrine_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M11"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_eyes_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M12"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_generalApp_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M13"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_genitalia_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M14"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_heart_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M15"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_historyOfPastIllness_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M16"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_integumentary_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M17"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_lymphatic_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M18"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_musculo_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M19"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_neurologic_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M20"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_respiratory_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M21"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_teeth_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M22"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_developpementPsychomoteur_CSE-CS24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">JDV_VaccinCSE24-CISIS</xsl:attribute>
            <svrl:text>Conformité d'un élément codé obligatoire par rapport à un jeu de valeurs du CI-SIS</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de conformité du document aux spécifications du modèle CSE-CS24_2021.01</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN S_codedPhysicalExam_CSE-CS24Vérification de la conformité de la section Examens physiques du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de la section Examens physiques du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système nerveux (1.3.6.1.4.1.19376.1.5.3.1.1.9.35) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système digestif (1.3.6.1.4.1.19376.1.5.3.1.1.9.31) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système musculo-squelettique (1.3.6.1.4.1.19376.1.5.3.1.1.9.34) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système réno-uro-génital (1.3.6.1.4.1.19376.1.5.3.1.1.9.36) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système cardiovasculaire (1.3.6.1.4.1.19376.1.5.3.1.1.9.29) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système auditif (1.3.6.1.4.1.19376.1.5.3.1.1.9.21) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système respiratoire (1.3.6.1.4.1.19376.1.5.3.1.1.9.30) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système endocrinien et métabolique (1.3.6.1.4.1.19376.1.5.3.1.1.9.25) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système tégumentaire (1.3.6.1.4.1.19376.1.5.3.1.1.9.17) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système lymphatique-hématologique-immunolique (1.3.6.1.4.1.19376.1.5.3.1.1.9.32) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Système occulaire (1.3.6.1.4.1.19376.1.5.3.1.1.9.19) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section Stomatologie (1.3.6.1.4.1.19376.1.5.3.1.1.9.23) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [S_codedPhysicalExam_CSE-CS24] Erreur de conformité : La sous-section État général (1.3.6.1.4.1.19376.1.5.3.1.1.9.16) est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_abdomen_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système digestif du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système digestif du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_abdomen_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "D5-30140" est obligatoire pour indiquer l'absence ou la présence de reflux gastro-oesophagien.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_abdomen_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "GEN-097" est obligatoire pour indiquer l'absence ou la présence d'une autre affection du système digestif.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_codedSocialHistory_CSE-CS24Vérification des entrées Habitus, Mode de vie (1.3.6.1.4.1.19376.1.5.3.1.4.13.4) du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées Habitus, Mode de vie (1.3.6.1.4.1.19376.1.5.3.1.4.13.4) du CSE-CS24</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN E_ears_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système auditif du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système auditif du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ears_CSE-CS24] Erreur de conformité : 
            L'entrée FR-Probleme de code "MED-178" est obligatoire pour indiquer si 'Test auditif normal' ou pas.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_eatingSleeping_CSE-CS24Schématrion Entrée Evaluation fonctionnelle du sommeil et de l'alimentation du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schématrion Entrée Evaluation fonctionnelle du sommeil et de l'alimentation du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_eatingSleeping_CSE-CS24] Erreur de conformité : 
...
<xsl:choose>
   ...
   <!--PATTERN E_endocrine_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système endocrinien et métabolique du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système endocrinien et métabolique du CSE-CS24</svrl:text>
...
<xsl:if test="(.//cda:entry/cda:observation[@negationInd=&#34;true&#34;]/cda:value/@code=&#34;DB-00000&#34;) and              (.//cda:entry/cda:observation[cda:value/@code=&#34;DB-00000&#34;]/cda:entryRelationship/cda:act/cda:text!=&#34;&#34;)">
   ...
   <!--PATTERN E_eyes_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système occulaire du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système occulaire du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_eyes_CSE-CS24] Erreur de conformité : 
   ...
   <!--PATTERN E_generalApp_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Etat général du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Etat général du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_generalApp_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "D4-0100" est obligatoire pour indiquer l'absence ou la présence de Syndrome polymalformatif.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_generalApp_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "D4-02214" est obligatoire pour indiquer l'absence ou la présence de trisomie 21.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_generalApp_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "D4-02000" est obligatoire pour indiquer l'absence ou la présence d'Aberrations chromosomiques.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_genitalia_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système réno-uro-génital du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système réno-uro-génital du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
                [E_genitalia_CSE-CS9] Erreur de conformité : 
                L'entrée FR-Probleme de code "GEN-097" est obligatoire pour indiquer l'absence ou la présence d'une autre affection du système réno-uro-génital.
            </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_heart_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système cardiovasculaire du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système cardiovasculaire du CSE-CS24</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN E_historyOfPastIllness_CSE-CS24Vérification des entrées relatives aux antécédents médicaux du CSE-CS24.-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées relatives aux antécédents médicaux du CSE-CS24.</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5']/cda:value/@code='MED-185'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:value/@code='MED-185']/cda:entryRelationship/@typeCode='CAUS'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5']/cda:value/@code='ORG-090'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text> 
            [E_historyOfPastIllness_CSE-SC24] Erreur de conformité :
            L'entrée FR-Probleme "Hospitalisation(s) depuis le 9ème mois" est obligatoire.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:value/@code='ORG-090']/cda:entryRelationship/@typeCode='CAUS'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:value/@code='ORG-090']/cda:entryRelationship/@typeCode='SUBJ'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN E_integumentary_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système tégumentaire du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système tégumentaire du CSE-CS24</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN E_lymphatic_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système lymphatique-hématologique-immunologique du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système lymphatique-hématologique-immunologique du CSE-CS24</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN E_musculo_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système musculosquelettique du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système musculosquelettique du CSE-CS24</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN E_neurologic_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système nerveux du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système nerveux du CSE-CS24</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN E_respiratory_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Système respiratoire du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Système respiratoire du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(/cda:ClinicalDocument/cda:templateId[@root=&#34;1.2.250.1.213.1.1.1.5.3&#34;]) or             (.//cda:entry/cda:observation/cda:value/@code=&#34;D2-51000&#34;)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_teeth_CSE-CS24Vérification des entrées FR-Probleme de la sous-section Stomatologie du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Probleme de la sous-section Stomatologie du CSE-CS24</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation/cda:value/@code=&#34;D5-10110&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation/cda:value/@code=&#34;MED-188&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN E_developpementPsychomoteur_CSE-CS24Vérification des entrées FR-Simple-Observation de la sous-section FR-Developpement-psychomoteur du CSE-CS24-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification des entrées FR-Simple-Observation de la sous-section FR-Developpement-psychomoteur du CSE-CS24</svrl:text>
...
<xsl:template match="*[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.7.3.1.1.13.4&#34;]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-196&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-197&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-198&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-199&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-200&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-201&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;MED-202&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;GEN-083&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test=".//cda:entry/cda:observation[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13&#34;]/cda:code/@code=&#34;GEN-084&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN JDV_CauseAccidentDom-CISIS-->
	...
	<!--RULE -->
<xsl:template match="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:act/cda:entryRelationship/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5' and cda:value/@code='MED-185']/cda:entryRelationship/cda:observation/cda:code"
                 priority="1000"
                 mode="M25">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:act/cda:entryRelationship/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5' and cda:value/@code='MED-185']/cda:entryRelationship/cda:observation/cda:code"/>
      <xsl:variable name="att_code" select="@code"/>
      <xsl:variable name="att_codeSystem" select="@codeSystem"/>
      <xsl:variable name="att_displayName" select="@displayName"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(             @nullFlavor or             (@xsi:type and not(@xsi:type = 'CD') and not(@xsi:type = 'CE')) or              (document($JDV_VaccinCSE24-CISIS)//svs:Concept[@code=$att_code and @codeSystem=$att_codeSystem])             )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            [<xsl:text/>
                  ...
                  <xsl:text/>] 
            doit faire partie du jeu de valeurs <xsl:text/>
                  <xsl:value-of select="$JDV_VaccinCSE24-CISIS"/>
                  <xsl:text/>.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:variable name="JDV_Activite-CISIS" select="'../jeuxDeValeurs/JDV_Activite-CISIS.xml'"/>
   ...
   <xsl:variable name="JDV_VaccinCSE24-CISIS"
                 select="'../jeuxDeValeurs/JDV_VaccinCSE24-CISIS.xml'"/>
   <xsl:variable name="JDV_CertitudeDiagnostic-CISIS"
                 select="'../jeuxDeValeurs/JDV_CertitudeDiagnostic-CISIS.xml'"/>

	  <!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1002" mode="M32">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:ClinicalDocument"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="./cda:templateId[@root='1.2.250.1.213.1.1.1.5.3']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:component/cda:section/cda:templateId[@root = &#34;1.3.6.1.4.1.19376.1.5.3.1.3.13&#34;]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
