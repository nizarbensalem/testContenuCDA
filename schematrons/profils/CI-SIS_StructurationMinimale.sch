...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="Struct_minimale" 
    ...
    <pattern id="variablesSM">
        ...
        <let name="jdv_typeCode_1" value="'../../jeuxDeValeurs/TRE_A04-LoincTypeDocument.xml'"/>
        <let name="jdv_typeCode_2" value="'../../jeuxDeValeurs/TRE_A04-Loinc.xml'"/>
        <let name="jdv_typeCode_3" value="'../../jeuxDeValeurs/TRE_A05-TypeDocComplementaire.xml'"/>
