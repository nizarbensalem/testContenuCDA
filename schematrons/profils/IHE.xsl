...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_pregnancyHistoryOrganizer_int] Erreur de conformité PCC : Une entrée FR-Historique-de-la-grossesse doit comporter un élément "auteur" pour représenter la personne ou le dispositif
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">IHE PRE Prescription Item Entry (1.3.6.1.4.1.19376.1.9.1.3.2)</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']"
                 priority="1000"
                 mode="M146">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']"/>
      <xsl:variable name="count_id"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:id) "/>
      <xsl:variable name="count_code"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:code[@code='DRUG'][@codeSystem='2.16.840.1.113883.5.4'])"/>
      <xsl:variable name="count_code_1"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:code)"/>
      <xsl:variable name="count_statusCode"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:statusCode[@code='completed'])"/>
      <xsl:variable name="count_statusCode_1"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:statusCode)"/>
      <xsl:variable name="count_text"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:text)"/>
      <xsl:variable name="count_routeCode"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:routeCode[@codeSystem='2.16.840.1.113883.5.112'])"/>
      <xsl:variable name="count_routeCode_1"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:routeCode)"/>
      <xsl:variable name="count_approachSiteCode_1"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:approachSiteCode)"/>
      <xsl:variable name="count_approachSiteCode"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:approachSiteCode[@codeSystem='2.16.840.1.113883.1.11.19724'])"/>
      <xsl:variable name="count_doseQuantity"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:doseQuantity)"/>
      <xsl:variable name="count_rateQuantity"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:rateQuantity)"/>
      <xsl:variable name="count_rateQuantity_low"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:rateQuantity/cda:low)"/>
      <xsl:variable name="count_rateQuantity_high"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:rateQuantity/cda:high)"/>
      <xsl:variable name="count_maxDoseQuantity"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:maxDoseQuantity)"/>
      <xsl:variable name="count_maxDoseQuantity_numerator"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:maxDoseQuantity/cda:numerator)"/>
      <xsl:variable name="count_maxDoseQuantity_denominator"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:maxDoseQuantity/cda:denominator)"/>
      <xsl:variable name="count_author"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:author)"/>
      <xsl:variable name="count_reference"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:reference)"/>
      <xsl:variable name="count_effectiveTime"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]/cda:effectiveTime)"/>
      <xsl:variable name="count_MA_normales"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.1']])"/>
      <xsl:variable name="count_MA_progressives"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.8']])"/>
      <xsl:variable name="count_MA_fractionnees"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.9']])"/>
      <xsl:variable name="count_MA_conditionnees"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.10']])"/>
      <xsl:variable name="count_MA_combinees"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.11']])"/>
      <xsl:variable name="count_MA_debutDiff"
                    select="count(//cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.21']])"/>
      <xsl:variable name="count_consumable"
                    select="count(//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:consumable/cda:manufacturedProduct[@classCode='MANU']/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.2'])"/>
      <xsl:variable name="count_ER_MotifTraitement"
      ...
      <xsl:variable name="count_E_traitementPrescrit"
                    select="count(//cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='INT']/cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2'])"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="($count_text=$count_E_traitementPrescrit)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="($count_routeCode=1 and $count_routeCode_1=1) or ($count_routeCode_1=0)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="($count_approachSiteCode&gt;=1 and $count_approachSiteCode_1&gt;=1) or ($count_approachSiteCode_1=0)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="($count_consumable = $count_E_traitementPrescrit)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
