...
<xsl:choose>
   ...
   <!--PATTERN E_dispositifMedical-2_ANSVérification de la conformité de de l'entrée FR-Dispositif-medical (1.2.250.1.213.1.1.3.20) créée par l'ANS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de de l'entrée FR-Dispositif-medical (1.2.250.1.213.1.1.3.20) créée par l'ANS</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='GEN-180'][@codeSystem='1.2.250.1.213.1.1.4.322'][@codeSystemName='TA_ASIP'][@displayName='En rapport avec un accident du travail'])=1)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
                ...
                - @displayName="En rapport avec un accident du travail" (cardinalité [1..1]) 
