...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS Medications</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.7&#34;]" priority="1007"
                 mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:template match="*[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.7&#34;]/cda:entryRelationship[@typeCode=&#34;RSON&#34;]/cda:act"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--REPORT -->
<xsl:if test="cda:templateId[@root != '1.3.6.1.4.1.19376.1.5.3.1.4.4.1'             and @root !='1.2.250.1.213.1.1.3.36']">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                 test="cda:templateId[@root != '1.3.6.1.4.1.19376.1.5.3.1.4.4.1' and @root !='1.2.250.1.213.1.1.3.36']">
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>
...
<xsl:template match="//cda:section[cda:templateId[@root='1.2.250.1.213.1.1.2.171']]/cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]"
      ...
      <xsl:variable name="count_ER_HorsAMM"
                    select="count(cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.12']])"/>
      ...
      <xsl:variable name="count_ER_EnRapportAT"
                    select="count(cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.14']])"/>
      <xsl:variable name="count_ER_NonRemboursable"
                    select="count(cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.15']])"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
                [2] [E_traitementPrescrit_fr.sch] Erreur de conformité CI-SIS : Il doit y avoir 5 occurences de l'élément 'templateId' dans cette entrée(cardinalité [5..5]) :
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(($count_ER_HorsAMM=1) or ($count_ER_HorsAMM=0))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(($count_ER_EnRapportAT=1) or ($count_ER_EnRapportAT=0))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(($count_ER_NonRemboursable=1) or ($count_ER_NonRemboursable=0))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS Entrée "FR-Traitement-prescrit-subordonnee"</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="//cda:entry/cda:substanceAdministration/cda:entryRelationship[@typeCode='COMP']/cda:substanceAdministration[@classCode='SBADM'][@moodCode='INT']"
                 priority="1000"
                 mode="M38">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cda:entry/cda:substanceAdministration/cda:entryRelationship[@typeCode='COMP']/cda:substanceAdministration[@classCode='SBADM'][@moodCode='INT']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.2.250.1.213.1.1.3.83.1']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
