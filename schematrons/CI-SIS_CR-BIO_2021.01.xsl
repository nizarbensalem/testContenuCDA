...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">S_FR-CR-de-biologie-code</xsl:attribute>
...
<xsl:choose>
   ...
   <!--PATTERN S_FR-CR-de-biologie-code-->


	<!--RULE -->
<xsl:template match="cda:structuredBody/cda:component/cda:section[cda:templateId/@root='1.3.6.1.4.1.19376.1.3.3.2.1']/cda:code"
                 priority="1000"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cda:structuredBody/cda:component/cda:section[cda:templateId/@root='1.3.6.1.4.1.19376.1.3.3.2.1']/cda:code"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
           ...
           [dansJeuDeValeurs] L'élément "<xsl:text/>
                  <xsl:value-of select="'ClinicalDocument/component/structuredBody/component/section/code'"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(             @nullFlavor or             (@xsi:type and not(@xsi:type = 'CD') and not(@xsi:type = 'CE')) or              (document($JDV_BIO_Chapitres-CISIS)//svs:Concept[@code=$att_code and @codeSystem=$att_codeSystem])             )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            doit faire partie du jeu de valeurs <xsl:text/>
                  <xsl:value-of select="$JDV_BIO_Chapitres-CISIS"/>
                  <xsl:text/>.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:template match="cda:procedure[./cda:templateId/@root='1.3.6.1.4.1.19376.1.3.1.2']"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="./cda:code/@codeSystem='1.2.250.1.213.2.7' or not(./cda:code) or ./cda:code/cda:originalText"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            Une entrée FR-Prelevement (1.3.6.1.4.1.19376.1.3.1.2), si elle est codée, doit utiliser un code issu de la terminologie NABM (@codeSystem='1.2.250.1.213.2.7'). 
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN JDV_BIO_Interpretation-CISIS-->
	...
	<!--RULE -->
<xsl:template match="cda:observation/cda:interpretationCode" priority="1000" mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:variable name="JDV_BIO_Interpretation-CISIS"
   ...
   <xsl:variable name="JDV_BIO_Chapitres-CISIS"
                 select="'../jeuxDeValeurs/JDV_BIO_Chapitres-CISIS.xml'"/>

	  <!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1001" mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:ClinicalDocument"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="cda:structuredBody/cda:component/cda:section" priority="1000" mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
